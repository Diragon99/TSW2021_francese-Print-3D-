...
--
-- Temporary view structure for view `prod_tot`
--

DROP TABLE IF EXISTS `prod_tot`;
/*!50001 DROP VIEW IF EXISTS `prod_tot`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `prod_tot` AS SELECT 
 1 AS `id_prodotto`,
 1 AS `prezzo_totale`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `prod_tot`
--
...
/*!50001 VIEW `prod_tot` AS select `prodotto`.`id_prodotto` AS `id_prodotto`,(`prodotto`.`prezzo_base` + `prodotto`.`iva`) AS `prezzo_totale` from `prodotto` */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cambia_prezzo`(prod integer, nuovo decimal(6,2), ivan decimal(5,2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `inserisci_prodotto`(id integer, descb varchar(50), descrizione varchar(300), disp bit, iva decimal (5,2), prezzo_base decimal(6,2), categoria varchar(20))
BEGIN
insert into prodotto values(id, descb, descrizione, disp, iva, prezzo_base, categoria);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
