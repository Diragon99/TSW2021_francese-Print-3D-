...
public class FatturaDAO {
	...
	public static FatturaBean doRetrieve(int o_id) {
		FatturaBean fb=new FatturaBean();
		fb.setOrdine(o_id);
		Connection connection = null;		
		PreparedStatement preparedStatement = null;
		String sql="select * from "+FatturaDAO.TABLE_NAME+" where ordine="+o_id;
		try {
			...
			if(rs.next()) {
				...
				fb.setOrdine(rs.getInt(2));
				fb.setCosto(rs.getFloat(3));
				fb.setPagamento(rs.getString(5));
				fb.setData(rs.getDate(6));
			}
